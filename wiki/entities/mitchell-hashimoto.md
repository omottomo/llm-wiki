...
미첼 하시모토는 HashiCorp의 공동창립자이자 Terraform을 만든 개발자이며, 터미널 프로그램 Ghostty의 제작자이기도 하다. 인프라를 코드로 선언하고 그 선언을 시스템이 강제하게 만든 그의 이력은, 하네스 엔지니어링과 같은 발상 위에 있다. 실제로 이 분야에서 "하네스"라는 말을 널리 퍼뜨린 인물로 언급된다.

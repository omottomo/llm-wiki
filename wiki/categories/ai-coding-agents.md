---
title: AI 코딩 에이전트 — 카테고리
type: overview
created: 2026-09-22
updated: 2026-09-22
sources: []
tags: [카테고리, 하네스엔지니어링, 에이전틱코딩, AI코딩]
---

# AI 코딩 에이전트

> AI에게 코드를 맡기는 방식이 프롬프트에서 하네스로, 다시 루프와 그래프로 옮겨 간 흐름을 모아 둔 카테고리다. 이 위키가 가장 먼저 쌓기 시작한 주제이고 지금도 가장 두껍다.
...
## 함께 보기
- [[categories/jev|Jev]] — 에이전트 앞단에 붙이는 판단 전용 모델
- [[categories/git|Git]] — 에이전트가 커밋을 쌓는 바탕

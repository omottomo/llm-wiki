---
title: 인프라와 웹 기술 — 카테고리
type: overview
created: 2026-09-22
updated: 2026-09-22
sources: []
tags: [카테고리, 코드형인프라, 쿠버네티스, 인프라]
---

# 인프라와 웹 기술

> 인프라를 코드로 선언하고, 컨테이너로 굴리고, 그 앞단의 이름·API를 다루는 기술들을 모아 둔 카테고리다. AI 코딩과 같은 사상(환경을 코드로 강제한다)이 인프라 쪽에서 먼저 자리 잡은 선례이기도 하다.
...
## 함께 보기
- [[categories/virtualization|가상화]] — 컨테이너 아래층에서 자원을 나누는 기술
- [[categories/ai-coding-agents|AI 코딩 에이전트]] — 같은 사상이 코딩 쪽에서 반복된다

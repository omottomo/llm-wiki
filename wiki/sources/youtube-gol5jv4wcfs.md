...
## 핵심 내용
- 자막 표기 주의: 영상 자막은 저자를 "안드레 카파시 / 안드레 카파 씨"로 표기하나, 이는 **[[entities/andrej-karpathy]](안드레이 카파시)**의 자막 오인식이다. OpenAI 공동창업자이자 전 Tesla AI 디렉터로, 그의 X 글이 출발점.
...
## 기존 위키와의 연결
- 강화: [[concepts/claude-md]]의 "짧고 검증 가능한 최소 규칙" 권장과 [[concepts/harness-engineering]]·[[concepts/verification-automation]]·[[concepts/skills]]를 강화 (→ [[sources/youtube-gol5jv4wcfs]]).
- 강화/모순: [[sources/youtube-hXlB1QstQ-Y]](#17), [[sources/youtube-cZ8_Dkk_Ce0]](#8)의 "CLAUDE.md로 품질 향상"을 강화하는 동시에, [[sources/youtube-c7_ANA1NiS0]](#6 "CLAUDE.md를 지워라")와 모순 관계. 화해 관점: #6의 비판 대상은 장황·불필요 규칙이고, 본 영상의 65줄은 "짧고 검증 가능한 최소 규칙"의 모범 사례 → [[concepts/claude-md]]에 양쪽 모두 기록.
- 신규: [[entities/andrej-karpathy]]를 핵심 인물로 도입(자막상 "안드레 카파시"로 표기되나 동일 인물). "Goal-Driven Execution = 검증 가능한 목표화" 패턴을 강조 (→ [[sources/youtube-gol5jv4wcfs]]).

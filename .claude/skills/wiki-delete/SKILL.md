...
- **By topic/source**: read `wiki/index.md`, open the matching category page under `wiki/categories/`, and enumerate the pages from there.
...
- Remove the deleted pages' entries from their category page(s) under `wiki/categories/`. If a subject loses every page, delete its category page too and remove its gateway line from `wiki/index.md`.

...
- ~~**색인이 임계치를 넘었다.**~~ → 2026-09-22 phase-20 에서 처리. 주제 MOC 5개(`wiki/moc/`)를 만들고 `index.md` 를 관문으로 바꿨다. 흡수 때 MOC 를 갱신하는 절차는 `wiki-ingest` §4-5 에 들어갔고, lint 가 MOC 경유 등재를 인정한다. 원래 적어 둔 메모는 아래에 남긴다.
